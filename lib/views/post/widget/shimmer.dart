...
class ShimmerProgram extends StatefulWidget {
  const ShimmerProgram({Key? key}) : super(key: key);

  @override
  State<ShimmerProgram> createState() => _ShimmerProgramState();
}

class _ShimmerProgramState extends State<ShimmerProgram> {
  @override
